...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Register = channel.unary_unary(
                '/chirp.auth.AuthService/Register',
        ...
        self.GetCurrentUser = channel.unary_unary(
                '/chirp.auth.AuthService/GetCurrentUser',
        ...
        self.ValidateSession = channel.unary_unary(
                '/chirp.auth.AuthService/ValidateSession',
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chirp.auth.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chirp.auth.AuthService', rpc_method_handlers)
