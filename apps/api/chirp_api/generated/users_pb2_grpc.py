...
class UsersServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                '/chirp.users.UsersService/GetUser',
                request_serializer=users__pb2.GetUserRequest.SerializeToString,
                response_deserializer=users__pb2.UserProfileResponse.FromString,
                _registered_method=True)
        self.UpdateProfile = channel.unary_unary(
                '/chirp.users.UsersService/UpdateProfile',
                request_serializer=users__pb2.UpdateProfileRequest.SerializeToString,
                response_deserializer=users__pb2.UpdateProfileResponse.FromString,
                _registered_method=True)
...
def add_UsersServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=users__pb2.UserProfileResponse.SerializeToString,
            ),
            'UpdateProfile': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=users__pb2.UpdateProfileResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'chirp.users.UsersService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chirp.users.UsersService', rpc_method_handlers)
...
class UsersService(object):
    ...
    def GetUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            users__pb2.UserProfileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def UpdateProfile(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            users__pb2.UpdateProfileResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
